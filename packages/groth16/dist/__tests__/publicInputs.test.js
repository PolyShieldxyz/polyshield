...
describe("public input ordering", () => {
    it("formats bet auth in vault order", () => {
        expect((0, publicInputs_1.formatBetAuthPublicInputs)({
            merkle_root: 1,
            nullifier: 2,
            new_commitment: 3,
            bet_amount: 4,
    ...
    it("formats settlement credit in vault order", () => {
        expect((0, publicInputs_1.formatSettlementCreditPublicInputs)({
            merkle_root: 1,
            nullifier: 2,
            new_commitment: 3,
            nullifier_of_bet: 4,
    ...
    it("formats withdrawal in vault order", () => {
        expect((0, publicInputs_1.formatWithdrawalPublicInputs)({
            merkle_root: 1,
            nullifier: 2,
            withdrawal_amount: 3,
            recipient_hash: 4,
    ...
    it("formats bet cancel in vault order", () => {
        expect((0, publicInputs_1.formatBetCancelPublicInputs)({
            merkle_root: 1,
            nullifier: 2,
            new_commitment: 3,
            nullifier_of_bet: 4,
    ...
    it("formats cancel credit in vault order", () => {
        expect((0, publicInputs_1.formatCancelCreditPublicInputs)({
            merkle_root: 1,
            nullifier: 2,
            new_commitment: 3,
            nullifier_of_bet: 4,
...
//# sourceMappingURL=publicInputs.test.js.map