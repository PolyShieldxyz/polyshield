...
// snarkJS-generated Groth16 verifier — position_close circuit (5 public signals).
...
contract PositionCloseG16Base {
    ...
    uint256 constant deltax1 = 15342782258172841163183966299572265108513236540573555222419238424610231609512;
    uint256 constant deltax2 = 7252554372639053802369004345098451423331197457253894721361619656419687090177;
    uint256 constant deltay1 = 15500380416922258658845353245322942011196547388685276147622842044835116736734;
    uint256 constant deltay2 = 14145133635131144660139889293820892346750876748179371986416787325548362753555;

    
    uint256 constant IC0x = 12412762151995572228056681747275755139192578551884300982920288613015636221630;
    uint256 constant IC0y = 1548996733167097228106242505148469364720660152055431967792606197387078468858;
    ...
    uint256 constant IC5x = 3950100144932334737603245699999820112109435761938306124578387475050887379882;
    uint256 constant IC5y = 539334049252786952409222252613480915626784655084420588416743008268698239198;
...
/// @notice UUPS-upgradeable IVerifier adapter for the Groth16 PositionClose circuit.
/// Proof encoding: abi.encode(uint256[2] pA, uint256[2][2] pB, uint256[2] pC) — 256 bytes.
/// Deployed behind an ERC1967Proxy; initialize(owner) deploys the PositionCloseG16Base.
/// VK re-key: deploy a new PositionCloseG16Base and call setBase(); adapter-logic change:
/// upgradeToAndCall to a new implementation.
contract PositionCloseVerifier is Initializable, UUPSUpgradeable, OwnableUpgradeable, IVerifier {
    address public base; // PositionCloseG16Base, in proxy storage
    ...
    function initialize(address owner_) external initializer {
        ...
        base = address(new PositionCloseG16Base());
    }
    ...
    function verify(bytes calldata proof, bytes32[] calldata publicInputs) external view returns (bool) {
        ...
        return PositionCloseG16Base(base).verifyProof(pA, pB, pC, sigs);
    }
