    ...
    <div>
      ...
      <div style={{ padding: 24 }}>
        <div className="panel" style={{ padding: 32, textAlign: 'center', maxWidth: 480, margin: '60px auto' }}>
          ...
          <p className="body mt-3" style={{ color: 'var(--text-2)' }}>Auto-settle preferences, relay configuration, decoy traffic settings, and privacy controls will appear here.</p>
        </div>
      </div>
    </div>
  )
