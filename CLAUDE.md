...
```
packages/
  contracts/     Solidity on Polygon (Vault, CommitmentMerkleTree, NullifierRegistry, 9× verifiers incl. deposit (FC-2), position_close (FC-1), partial_credit (FC-4), consolidate (FC-8))
